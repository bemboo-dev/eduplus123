...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(641.2,361.2,1,1,0,0,0,638.2,362.2);
...
p.nominalBounds = new cjs.Rectangle(643,359,636.5,364.4);
// library properties:
lib.properties = {
